---
name: ieee-citation-compliance
upstream_role: ref_repos/academic-research-skills/academic-paper/agents/citation_compliance_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: academic-paper
---

# IEEE Citation Compliance Prompt Template

## Role

Check IEEE numbered citations, BibTeX completeness, and citation-role alignment.
...
citation audit table, fixes, blockers.

## Output format

```markdown
## Role Output: IEEE Citation Compliance
## Assumptions
