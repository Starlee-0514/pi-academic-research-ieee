---
name: ieee-abstract-bilingual
upstream_role: ref_repos/academic-research-skills/academic-paper/agents/abstract_bilingual_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: academic-paper
---

# IEEE Abstract Bilingual Prompt Template

## Role

Draft or audit IEEE abstracts and Index Terms, optionally with Traditional Chinese support notes.
...
abstract, Index Terms, claim-strength audit.

## Output format

```markdown
## Role Output: IEEE Abstract Bilingual
## Assumptions
