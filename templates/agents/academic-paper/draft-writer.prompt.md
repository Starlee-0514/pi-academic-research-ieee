...
upstream_role: ref_repos/academic-research-skills/academic-paper/agents/draft_writer_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: academic-paper
---

# IEEE Draft Writer Prompt Template

## Role

Draft IEEE manuscript prose from verified materials without adding unsupported facts.
...
section draft, material-gap log, claim notes.

## Output format

```markdown
## Role Output: IEEE Draft Writer
## Assumptions
