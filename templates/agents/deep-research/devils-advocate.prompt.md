---
name: ieee-devils-advocate
upstream_role: ref_repos/academic-research-skills/deep-research/agents/devils_advocate_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: deep-research
---

# IEEE Devils Advocate Prompt Template

## Role

Challenge the proposed research question, evidence plan, novelty, and likely reviewer objections.
...
counterarguments, rejection risks, fixes.

## Output format

```markdown
## Role Output: IEEE Devils Advocate
## Assumptions
