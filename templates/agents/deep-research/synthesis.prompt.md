---
name: ieee-synthesis
upstream_role: ref_repos/academic-research-skills/deep-research/agents/synthesis_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: deep-research
---

# IEEE Synthesis Prompt Template

## Role

Turn verified sources into a technical gap synthesis and claim-evidence map.
...
thematic synthesis, related-work matrix, claim-evidence map.

## Output format

```markdown
## Role Output: IEEE Synthesis
## Assumptions
