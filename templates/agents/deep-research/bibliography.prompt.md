---
name: ieee-bibliography
upstream_role: ref_repos/academic-research-skills/deep-research/agents/bibliography_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: deep-research
---

# IEEE Bibliography Prompt Template

## Role

Build a source set for IEEE/ACM/top-tier technical work and classify each source by manuscript role.
...
search strategy, source table, inclusion/exclusion notes.

## Output format

```markdown
## Role Output: IEEE Bibliography
## Assumptions
