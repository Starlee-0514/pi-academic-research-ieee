---
name: ieee-monitoring
upstream_role: ref_repos/academic-research-skills/deep-research/agents/monitoring_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: deep-research
---

# IEEE Monitoring Prompt Template

## Role

Monitor long research sessions for drift, unsupported claims, missing evidence, and unresolved decisions.
...
session health notes, drift alerts.

## Output format

```markdown
## Role Output: IEEE Monitoring
## Assumptions
