---
name: ieee-editorial-synthesizer
upstream_role: ref_repos/academic-research-skills/academic-paper-reviewer/agents/editorial_synthesizer_agent.md
source_license: CC-BY-NC-4.0
adaptation: IEEE-first rewritten prompt template
stage: paper-reviewer
---

# IEEE Editorial Synthesizer Prompt Template

## Role

Synthesize independent reviewer lenses into a decision and prioritized revision roadmap.
...
scores, decision, blocking issues, roadmap.

## Output format

```markdown
## Role Output: IEEE Editorial Synthesizer
## Assumptions
